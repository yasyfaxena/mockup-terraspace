...
/**
 * `value` is BE's real `booking.accessCode` (V1 built a client-side
 * pseudo-payload string instead — since V2's API actually issues one, use
 * it directly rather than reconstructing something similar).
 */
