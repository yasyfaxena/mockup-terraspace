...
```json
{
  "data": [
    {
      "id": "b1e2…",
      "slug": "terraspace-johor-bahru",
      "name": "TerraSpace Johor Bahru",
      "address": "Jalan Wong Ah Fook",
      "city": "Johor Bahru",
      "imageUrl": "https://…/johor-bahru.jpg",
      "openingHours": "Mon–Sun 09:00–22:00",
      "access247": false,
      "description": "Central Johor Bahru coworking …",
      "latitude": "1.465500",
      "longitude": "103.757800",
      "timezone": "Asia/Kuala_Lumpur",
      "amenities": [
        { "id": "a1…", "name": "Wi-Fi", "category": "Connectivity", "icon": "wifi" },
        { "id": "a2…", "name": "Parking", "category": "Facility", "icon": "car" }
      ],
      "stats": {
...
Detail page. **Access:** Public. `:slug` is the URL identifier (`terraspace-johor-bahru`).
...
{
  "data": [
    { "id": "b1e2…", "slug": "terraspace-johor-bahru", "name": "TerraSpace Johor Bahru",
      "address": "Jalan Wong Ah Fook", "city": "Johor Bahru", "imageUrl": "https://…",
      "openingHours": "Mon–Sun 09:00–22:00", "access247": false, "description": "…",
      "latitude": "1.465500", "longitude": "103.757800", "accessRadiusMeters": 50,
      "timezone": "Asia/Kuala_Lumpur", "status": "active", "workspaceCount": 30,
      "amenityIds": ["a1…", "a2…"],
...
```json
{
  "slug": "terraspace-danga-bay",
  "name": "TerraSpace Danga Bay",
  "address": "Jalan Skudai",
  "city": "Johor Bahru",
  "imageUrl": "https://…/danga-bay.jpg",
...
| `timezone` | string | ✖ | `"Asia/Kuala_Lumpur"` | **IANA zone.** Validate against `Intl.supportedValuesOf("timeZone")`; reject fixed offsets like `+07:00` |
| `status` | enum | ✖ | `active` | |
