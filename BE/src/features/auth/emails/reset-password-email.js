  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(
        ...
        createElement(Heading, { as: "h2" }, "Reset your password"),
        createElement(Text, null, `Hi ${name}, use the link below to choose a new password.`),
        createElement(Button, { href: url, style: BUTTON_STYLE }, "Reset password"),
        createElement(
          Text,
