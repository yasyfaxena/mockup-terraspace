...
import { googleMapsEmbedUrl, googleMapsUrl } from "@/shared/geocoding";

/**
 * Read-only map preview for a location's coordinates. Embeds Google Maps
 * directly via its key-less iframe embed — no map SDK, no billed API key
 * needed — plus a link out to the same point in Google Maps.
 */
