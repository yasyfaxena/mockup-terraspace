...
export function HowItWorksPage() {
  ...
  const steps = [
    {
      ...
      copy:
        locale === "id"
          ? "Cari lokasi, tanggal, dan ruang rapat eksekutif. Ketersediaan terhubung live ke database."
    ...
    },
    {
      ...
      copy:
        locale === "id"
          ? "Gunakan QRIS, Virtual Account, kartu debit/kredit, atau transfer bank dengan verifikasi instan."
  ...
  return (
    <SiteShell>
        ...
        <ol className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {steps.map((s, i) => (
            ...
            >
              ...
              <h2 className="mt-1 text-base font-bold text-foreground">{s.title}</h2>
      ...
      <section className="border-y border-border bg-surface py-12">
        <div className="container-page grid gap-8 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-6 space-y-1.5 rounded-2xl border border-border bg-card p-5 font-mono text-xs shadow-[var(--shadow-soft)]">
              <div className="flex items-center justify-between border-b border-border pb-2">
                <span className="font-bold text-primary">BOOKING CONFIRMED</span>
                <span className="rounded bg-primary/10 px-2 py-0.5 text-[11px] font-semibold text-primary">
                  READY
                </span>
              </div>
              <p className="pt-2 text-muted-foreground">Workspace: Event Space (Johor Bahru)</p>
              ...
              <p className="font-semibold text-foreground">Window: 08:30–11:30 (Active ±30m)</p>
            </div>
          </div>
      ...
      <section className="container-page py-12">
        <div className="flex flex-wrap items-center justify-between gap-6 rounded-2xl border border-border bg-card p-8 shadow-[var(--shadow-soft)]">
          <div>
            <h2 className="text-h2 font-bold">
          ...
          <div className="flex flex-wrap gap-3">
            <Button asChild size="lg" className="bg-galaxy-accent font-semibold text-white">
