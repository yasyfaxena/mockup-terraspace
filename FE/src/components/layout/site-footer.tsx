  ...
  const columns = [
    {
      ...
      links: [
        { label: t("nav.locations"), to: "/locations" as const },
        { label: t("nav.workspaces"), to: "/workspaces" as const },
        { label: t("nav.amenities"), to: "/amenities" as const },
        { label: t("nav.how"), to: "/how-it-works" as const },
      ],
    },
    {
      ...
      links: [
        ...
        { label: t("cta.signup"), to: "/signup" as const },
      ],
    },
    {
      title: locale === "id" ? "Bantuan" : "Support",
      links: [
        { label: t("nav.help"), to: "/help" as const },
        { label: locale === "id" ? "Masuk" : "Log in", to: "/login" as const },
        { label: locale === "id" ? "Daftar Akun" : "Sign up", to: "/signup" as const },
      ],
    },
  ];
